...
| `tire` | Pneus abandonados em terrenos e quintais |
...
| **Total unificado** | **2 classes** | **6.749 imagens** |
...
Este projeto foi desenvolvido para fins acadêmicos no contexto da FETIN 2026.├── requirements.txt      ← Dependências do projeto
└── README.md
```
